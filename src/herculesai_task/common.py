...
class TaskRelevancy(BaseModel):
    ...
    relevant: bool = Field(
        description="Whether the task is relevant to main objective of the contract"
    )
    ambiguous: bool = Field(
        description="Whether the relevancy of the task is ambiguous."
    )
...
class TaskJudgement(BaseModel):
    ...
    explanation: str = Field(
        description="Short chain-of-thought reasoning for whether the task should be accepted or not."
    )
    ambiguous: bool = Field(
        description="Whether the validity of the task is ambiguous."
    )
